...
Route::get('/homePA','kuisController@homePa');
Route::view('homePA', 'homePA');
Route::view('profile', 'profilePA');
Route::view('createarticle', 'createarticle');
Route::get('/add', function () {
    return view('add');
});
Route::get('/show', 'ArtikelController@show');
...
Route::get('image/{article}', 'ArtikelController@displayImage')->name('image.displayImage');
